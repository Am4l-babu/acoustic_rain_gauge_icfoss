...
bool call() {
  ...
  if (response.startsWith(F("Acc"))) {
    ...
    void transmit(Accumulation1,Event_Accumulation1,Total_Accumulation1,Rain_Intensity1);
    delay(1000);
  }
...
void transmit(int Accumulation,int Event_Accumulation,int Total_Accumulation,int Rain_Intensity )
