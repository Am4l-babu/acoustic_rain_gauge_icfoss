...
static const PROGMEM u1_t NWKSKEY[16] = { 0xEB, 0x71, 0x03, 0x87, 0x09, 0xBA, 0xAC, 0x6C, 0x6C, 0x09, 0x9A, 0x6A, 0x69, 0xFB, 0xE0, 0x98 };

// LoRaWAN AppSKey, application session key
// This should also be in big-endian (aka msb).
static const u1_t PROGMEM APPSKEY[16] = { 0xA0, 0xE5, 0xD0, 0xA1, 0x92, 0xE9, 0x38, 0xDC, 0xB4, 0xF8, 0x2A, 0x57, 0xAF, 0x16, 0x13, 0xB4 };

// LoRaWAN end-device address (DevAddr)
// See http://thethingsnetwork.org/wiki/AddressSpace
// The library converts the address to network byte order as needed, so this should be in big-endian (aka msb) too.
static const u4_t DEVADDR = 0xfc0094e6 ; // <-- Change this address for every node!
...
void rg()
{
  ...
  if (previous_accumulation != b && d>0 && a>0.03)
  {
